      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          <div className="animate-slide-in-right order-2 md:order-1">
            ...
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-4 sm:mb-5 md:mb-6 leading-relaxed">Há mais de 7 anos trazendo o melhor da barbearia tradicional com um toque moderno. Nossa missão é fazer cada cliente sair daqui não apenas com um visual renovado, mas com a autoestima lá em cima.</p>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              <div className="text-center hover:scale-110 transition-all duration-300 animate-scale-in" style={{
              animationDelay: "0.2s"
            }}>
                ...
                <p className="font-bold text-lg sm:text-xl md:text-2xl text-foreground">7+</p>
              ...
              animationDelay: "0.4s"
                ...
                <p className="font-bold text-2xl text-foreground">2000+</p>
