    ...
    return (
      <div className="fixed bottom-3 right-3 sm:bottom-4 sm:right-4 z-40">
        <button
          ...
          className="p-2 sm:p-3 bg-secondary rounded-full hover:bg-primary/20 transition-all opacity-30 hover:opacity-100 shadow-lg"
          title="Painel Admin"
        >
          <Scissors className="w-4 h-4 sm:w-5 sm:h-5 text-muted-foreground" />
        </button>
      </div>
    );
  }
    ...
    <div className="fixed inset-0 bg-background/95 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <Card className="w-full max-w-5xl my-4 sm:my-8 p-4 sm:p-6 md:p-8 bg-card border-border">
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-foreground">Painel Administrativo</h2>
          <Button
            variant="ghost"
            onClick={() => {
              setIsOpen(false);
